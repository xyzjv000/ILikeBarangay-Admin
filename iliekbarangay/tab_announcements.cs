                ...
                else
                {
                    ...
                    if (resu == DialogResult.Yes)
                    {
                        ...
                        {   //Offline
                            ...
                            cmda.CommandText = "update ANNOUNCEMENT set ANNOUNCEMENT_NAME = @name,ANNOUNCEMENT_CONTENT= @content,ANNOUNCEMENT_DATE= @date, ANNOUNCEMENT_POSTEDON = @dt  WHERE ANNOUNCEMENT_ID = @id";
                            ...
                            string connString = "Server =remotemysql.com; Port = 3306; Database =T2W4fqv6NB; Uid = T2W4fqv6NB; Pwd = gkQSco3cAC;";
                            MySqlConnection conn = new MySqlConnection(connString);
                            MySqlCommand cmd = new MySqlCommand("update ANNOUNCEMENT set ANNOUNCEMENT_NAME = @name,ANNOUNCEMENT_CONTENT= @content,ANNOUNCEMENT_DATE= @date, ANNOUNCEMENT_POSTEDON = @dt WHERE ANNOUNCEMENT_ID = @id", conn);
