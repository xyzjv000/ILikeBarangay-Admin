...
namespace iliekbarangay
{
    public partial class AdminMain : Form
    {
        ...
        private void announcements_Click(object sender, EventArgs e)
        {
            ...
            tab_announcements.Instance.ID = this.ID.Trim();
        }
        ...
        private void transactions_Click(object sender, EventArgs e)
        {
            ...
            if (!PanelBody.Controls.Contains(Transactions.Instance))
            {
                PanelBody.Controls.Add(Transactions.Instance);
                Transactions.Instance.Dock = DockStyle.Fill;
                Transactions.Instance.BringToFront();
            }
            else
            {
                Transactions.Instance.BringToFront();
