    ...
    public partial class tab_staffProfile : UserControl
    {
        ...
        private void save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    cmd3.CommandText = "UPDATE STAFF SET STAFF_FNAME =@fname ,STAFF_MNAME = @mname ,STAFF_LNAME = @lname,STAFF_CNUM = @cnum,STAFF_ADDRESS = @add,STAFF_DOB =@dob,STAFF_GENDER= @gender,STAFF_USERNAME = @username,STAFF_PASSWORD =@pass,STAFF_IMAGE = @pic WHERE STAFF_ID = '" + ID + "'";
                ...
                {
                    cmd3.CommandText = "UPDATE STAFF SET STAFF_FNAME =@fname ,STAFF_MNAME = @mname ,STAFF_LNAME = @lname,STAFF_CNUM = @cnum,STAFF_ADDRESS = @add,STAFF_DOB =@dob,STAFF_GENDER= @gender,STAFF_IMAGE = @pic,STAFF_USERNAME = @username  WHERE STAFF_ID = '" + ID + "'";
                    profileImage.Image = resizeImage(profileImage.Image, new Size(177, 151));
                    profileImage.Image.Save(stream, System.Drawing.Imaging.ImageFormat.Jpeg);
                    byte[] pic = stream.ToArray();
                    cmd3.Parameters.AddWithValue("@fname", fname.Text);
                ...
                {
                    cmd3.CommandText = "UPDATE STAFF SET STAFF_FNAME =@fname ,STAFF_MNAME = @mname ,STAFF_LNAME = @lname,STAFF_CNUM = @cnum,STAFF_ADDRESS = @add,STAFF_DOB =@dob,STAFF_GENDER= @gender, STAFF_USERNAME = @username WHERE STAFF_ID = '" + ID + "'";
                    cmd3.Parameters.AddWithValue("@fname", fname.Text);
                    cmd3.Parameters.AddWithValue("@mname", mi.Text);
                    cmd3.Parameters.AddWithValue("@lname", lname.Text);
                    cmd3.Parameters.AddWithValue("@cnum", cnum.Text);
                ...
                {
                    cmd3.CommandText = "UPDATE STAFF SET STAFF_FNAME =@fname ,STAFF_MNAME = @mname ,STAFF_LNAME = @lname,STAFF_CNUM = @cnum,STAFF_ADDRESS = @add,STAFF_DOB =@dob,STAFF_GENDER= @gender, STAFF_USERNAME = @username, STAFF_PASSWORD = @pass WHERE STAFF_ID = '" + ID + "'";
                    cmd3.Parameters.AddWithValue("@fname", fname.Text);
                    cmd3.Parameters.AddWithValue("@mname", mi.Text);
                    cmd3.Parameters.AddWithValue("@lname", lname.Text);
                    cmd3.Parameters.AddWithValue("@cnum", cnum.Text);
